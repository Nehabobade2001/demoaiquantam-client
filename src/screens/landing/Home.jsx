...
const Home = () => {
  ...
  const rows = [
    [
      ...
      <a
        className="truncate text-[#B3B3B3] cursor-pointer hover:text-blue-400"
      ...
      "Transfer POX",
      <a className="hover:text-blue-400" href="/address-account/Governance">
        Governance
      </a>,
      ...
      "45,000,000.000000",
      <p className="text-blue-400 font-semibold">SUCCESS</p>,
    ],
    [
      <a
        className="hover:text-blue-400"
