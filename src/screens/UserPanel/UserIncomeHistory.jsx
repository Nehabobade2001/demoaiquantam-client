...
const UserIncomeHistory = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row) => (
        <span className="font-medium text-white">
          {maskWalletAddress(row?.mainAddress) || "Company Wallet"}
        </span>
      ),
    },
    {
      ...
      cell: (row) => (
        <span className="font-medium text-white">
          ${row?.income || row?.investment || row?.amount || "-"}
        </span>
      ),
    },
    {
    ...
    },
    {
      ...
      accessor: "role",
      cell: (row) => (
        <span className="font-medium text-white">{row?.role || "USER"}</span>
      ),
    },
    {
      header: "Status",
    ...
    },
    {
      ...
      accessor: "hash",
      cell: (row) => (
        <span className="font-medium text-white">{row?.hash || "N/A"}</span>
      ),
    },
  ];
