...
export const AuthenticatedUserRouters = {
  ...
  ROYALTY_CLUB_INCOME: "/royalty-club-income",
  ROI_INCOME: "/trading-income",
  SINGLE_LEG_INCOME: "/single-leg-income",
  TRADING_INCOME_HISTORY: "/trading-income-history",
  RANK_REWARD_HISTORY: "/rank-reward-history",
  FIXED_STAKING_YIELD: "/fixed-staking-yield",
  GLOBAL_ACHIEVERS: "/global-achievers",
  AWARD_REWARDS: "/award-rewards",
  AWARD_REWARD_HISTORY: "/award-reward-history",
  ...
  TOKEN_POCKET_STAKING: "/token-pocket-staking",
...
export const AuthenticatedAdminRouters = {
  ...
  MANAGE_REWARD_TIERS: "/manage-reward-tiers",
  AWARD_REWARD_MANAGEMENT: "/award-reward-management",
  AWARD_REWARD_HISTORY: "/award-reward-history",
