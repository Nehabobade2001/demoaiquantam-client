...
import ROIIncome from "../../screens/AdminPanel/ROIIncome";
import SingleLegIncome from "../../screens/AdminPanel/SingleLegIncome";
...
import ManagePlans from "../../screens/AdminPanel/ManagePlans";
import InvestmentPlans from "../../screens/UserPanel/InvestmentPlans";
import PlanHistory from "../../screens/UserPanel/PlanHistory";
import PlanReinvestment from "../../screens/UserPanel/PlanReinvestment";
import UserSingleLegIncome from "../../screens/UserPanel/UserSingleLegIncome";
import UserROIIncome from "../../screens/UserPanel/UserROIIncome";
import RoyaltyClubIncome from "../../screens/UserPanel/RoyaltyClubIncome";
import ManageRewardTiers from "../../screens/AdminPanel/ManageRewardTiers";
import AwardRewardHistory from "../../screens/AdminPanel/AwardRewardHistory";
import FixedStakingYield from "../../screens/UserPanel/FixedStakingYield";
import InvestmentPackages from "../../screens/UserPanel/InvestmentPackages";
import UserAwardRewards from "../../screens/UserPanel/UserAwardRewards";
import UserAwardRewardHistory from "../../screens/UserPanel/UserAwardRewardHistory";
import AdminAwardManagement from "../../screens/AdminPanel/AdminAwardManagement";
import ManualPayment from "../../screens/UserPanel/ManualPayment";
import AdminManualPayments from "../../screens/AdminPanel/AdminManualPayments";
import TokenPocketStaking from "../../screens/UserPanel/TokenPocketStaking";
import StakingHistory from "../../screens/UserPanel/StakingHistory";
      ...
      {role === "USER" ? (
        <Routes>
          ...
          >
            ...
            />
            <Route
              path={AuthenticatedUserRouters.INVESTMENT_PLANS}
              element={<InvestmentPlans />}
            />
            <Route
              path={AuthenticatedUserRouters.INVESTMENT_PACKAGES}
              element={<InvestmentPackages />}
            />
            <Route
              path={AuthenticatedUserRouters.PLAN_HISTORY}
              element={<PlanHistory />}
            />
            <Route
              path={AuthenticatedUserRouters.PLAN_REINVEST}
              element={<PlanReinvestment />}
            />
            <Route
            ...
            />
            <Route
              path={AuthenticatedUserRouters.ROYALTY_CLUB_INCOME}
              element={<RoyaltyClubIncome />}
            />
            <Route
            ...
            <Route
              ...
              element={<UserROIIncome />}
            />
            <Route
              path={AuthenticatedUserRouters.SINGLE_LEG_INCOME}
              element={<UserSingleLegIncome />}
            />
            <Route
              path={AuthenticatedUserRouters.FIXED_STAKING_YIELD}
              element={<FixedStakingYield />}
            />
            <Route
              path={AuthenticatedUserRouters.AWARD_REWARDS}
              element={<UserAwardRewards />}
            />
            <Route
              path={AuthenticatedUserRouters.AWARD_REWARD_HISTORY}
              element={<UserAwardRewardHistory />}
            />
            <Route
              path={AuthenticatedUserRouters.TOKEN_POCKET_STAKING}
              element={<TokenPocketStaking />}
            />
            <Route
              path={AuthenticatedUserRouters.MANUAL_PAYMENT}
              element={<ManualPayment />}
            />
            <Route
              path={AuthenticatedUserRouters.STAKING_HISTORY}
        ...
        <Routes>
          ...
          >
            ...
            />
            <Route
              path={AuthenticatedAdminRouters.ROI_INCOME}
              element={<ROIIncome />}
            />
            <Route
              path={AuthenticatedAdminRouters.SINGLE_LEG_INCOME}
              element={<SingleLegIncome />}
            />
            <Route
            ...
            />
            <Route
              path={AuthenticatedAdminRouters.MANAGE_PLANS}
              element={<ManagePlans />}
            />
            <Route
            ...
            />
            <Route
              path={AuthenticatedAdminRouters.MANAGE_REWARD_TIERS}
              element={<ManageRewardTiers />}
            />
            {/* <Route
              path={AuthenticatedAdminRouters.AWARD_REWARD_MANAGEMENT}
              element={<AdminAwardManagement />}
            /> */}
            <Route
              path={AuthenticatedAdminRouters.AWARD_REWARD_HISTORY}
              element={<AwardRewardHistory />}
            />
            <Route
              path={AuthenticatedAdminRouters.TRADING_INCOME_HISTORY}
              element={<TradingList />}
            />
            <Route
              path={AuthenticatedAdminRouters.FIXED_STAKING_YIELD}
              element={<FixedStakingYield />}
            />
            <Route
              path={AuthenticatedAdminRouters.MANUAL_PAYMENT_REQUESTS}
              element={<AdminManualPayments />}
            />
            <Route
              path={AuthenticatedAdminRouters.ACHIEVEMENT_REWARDS}
              element={<RankRewardHistory />}
            />
          </Route>
