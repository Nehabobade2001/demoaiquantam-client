          ...
          >
            ...
            <div className="flex flex-row items-center justify-between w-full">
              <div>
                ...
                <p className="pb-2 text-sm font-medium dark:text-[#A5D0FB] text-[#000000]">
                  Reward: <span className="dark:text-[#7FB6F3] text-[#A5D0FB]">{block.reward}</span>
                </p>
                <a
              ...
              <div className="text-right">
                <p className="pb-2 text-sm font-medium text-[#A5D0FB]">
                  {block.trx}
                </p>
                <div className="pb-2 flex items-center justify-end space-x-1 text-[#A5D0FB]">
                  <svg
